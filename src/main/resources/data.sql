-- Level Table 더미데이터
INSERT INTO level (level_id, level, reward_rate) VALUES
(1, 'WHITE', 1),
(2, 'SILVER', 2),
(3, 'GOLD', 3);

-- Users Table 더미데이터
INSERT INTO member (member_id, level_id, id, email, password, name, tel, birth_date, gender, point, recently_login, is_member_status, is_login_status)
VALUES
(1, 1, 'user1', 'user1@example.com', 'password1', 'User 1', '010-2456-7890', '1998-01-01', 'M', 100, '2023-11-01 12:00:00', TRUE, FALSE),
(2, 2, 'user2', 'user2@example.com', 'password2', 'User 2', '010-1654-3210', '1995-03-15', 'F', 50, '2023-10-02 09:30:00', TRUE, TRUE),
(3, 1, 'user3', 'user3@example.com', 'password3', 'User 3', '010-5222-3333', '1988-07-20', 'M', 200, '2023-01-03 15:45:00', TRUE, FALSE);


-- Addresses Table 더미데이터
INSERT INTO addresses (address_id, member_id, name, address, det_address, is_def_address)
VALUES
...
(3, 4, 'Announcement title3', 'Announcement content3', TRUE, 75, '2023-01-07 14:15:00', '2023-01-07 15:20:00');
...
-- Items Table 더미데이터
INSERT INTO item (item_id, category_id, name, content, price, discount_rate, sell_price, stock, is_sell_check, is_delete_check, created_date, modified_date, main_img, serve_img)
VALUES
...
-- Carts Table 더미데이터
INSERT INTO cart (cart_id, member_id, item_id, stock, price, checked) VALUES
(1, 1, 101, 2, 30, TRUE),
(2, 2, 102, 1, 50, FALSE),
(3, 3, 103, 3, 20, TRUE);

-- Orders Table 더미데이터
INSERT INTO orders (order_id, member_id, ordered_date, shipped_date, price, name, address, det_address, request, tel, status, refund_text)
VALUES
...
INSERT INTO order_detail (order_det_id, item_id, order_id, fixed_price, discount_rate, sell_price, count)
VALUES
...
-- QA Table 더미데이터
INSERT INTO item_qa (item_qa_id, item_id, member_id, title, content, written_date, edited_date)
VALUES
...
INSERT INTO qa_comment (qa_comment_id, admin_id, item_qa_id, content, written_date, edited_date)
VALUES
...
-- Reviews Table 더미데이터
INSERT INTO review (review_id, member_id, item_id, title, content, star, written_date, edited_date)
VALUES
...
INSERT INTO wishlist (wishlist_id, member_id, item_id)
VALUES
(1, 1, 102),
(2, 2, 103),
(3, 3, 101);